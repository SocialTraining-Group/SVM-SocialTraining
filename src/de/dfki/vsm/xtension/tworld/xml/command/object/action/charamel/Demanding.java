...
import de.dfki.charactor.v4235.Morph;
 ...
 *
 */
public class Demanding extends Action implements XMLParseable, XMLWriteable {
    ...
    public Demanding(String intensity, String aid) {
        mName = "caixml";
    ...
    public void writeXML(IOSIndentWriter out) throws XMLWriteError {
        ...
        track1.morph(Integer.parseInt(mCharameAvatarId), Float.parseFloat(mIntentsity), 3000, Morph.Demanding);
