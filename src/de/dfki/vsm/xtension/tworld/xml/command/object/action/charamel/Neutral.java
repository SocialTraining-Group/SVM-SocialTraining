 ...
 *
 */
public class Neutral extends Action implements XMLParseable, XMLWriteable {
    ...
    public Neutral(String intensity, String aid) {
        mName = "caixml";
    ...
    public void writeXML(IOSIndentWriter out) throws XMLWriteError {
        ...
        track1.morph(Integer.parseInt(mCharameAvatarId), Float.parseFloat(mIntentsity), 3000, Morph.Neutral);
